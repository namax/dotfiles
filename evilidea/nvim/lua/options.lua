...
vim.opt.updatetime = 250      -- I have a modern machine. No need to wait that long
...
-- Leader key NOTE: Must happen before plugins are required (otherwise wrong leader will be used)                                            
vim.g.mapleader = ' '
